...
export function ExplorerControls() {
  ...
  return (
    <Card className="border-l-primary/50 h-full border-l-4">
      <CardHeader>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-2">
          ...
          <Select
            value={dataset}
            onValueChange={(v) => handleUpdate('dataset', v)}
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            value={visualization}
            onValueChange={(v) => handleUpdate('view', v)}
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            value={colorBy}
            onValueChange={(v) => handleUpdate('colorBy', v)}
          >
